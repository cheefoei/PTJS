...
public class Schedule {
    ...
    private String schedule_id, schedule_list_id, jobseeker_id, timeFrom, timeTo, schedule_list_date;
    ...
    public Schedule(String schedule_id, String schedule_list_id, String jobseeker_id, String schedule_list_date) {
        this.schedule_id = schedule_id;
    ...
    public Schedule(String schedule_id, String schedule_list_id, String jobseeker_id, String timeFrom, String timeTo, String schedule_list_date) {
        this.schedule_id = schedule_id;
        this.schedule_list_id = schedule_list_id;
        this.jobseeker_id = jobseeker_id;
        this.timeFrom = timeFrom;
