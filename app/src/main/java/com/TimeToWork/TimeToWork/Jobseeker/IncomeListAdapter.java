...
public class IncomeListAdapter extends ArrayAdapter<Report> {
    ...
    public IncomeListAdapter(Context context, int textViewResourceId, ArrayList<Report> reports) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (report != null) {
            ...
            if (name != null) {
                name.setText((report.getCompany_name()));
            }
            if (job != null) {
